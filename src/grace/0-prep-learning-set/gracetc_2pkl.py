...
train=pd.read_pickle("/home/data/refined/candescence/train-data/grace_tc/train_grace_tc.4.pkl")


val=pd.read_pickle("/home/data/refined/candescence/train-data/grace_tc/val_grace_tc.4.pkl")
...
import pickle
pickle.dump(train, open("/home/data/refined/candescence/train-data/grace_tc/train_grace_tc.4.pkl", "wb"))  # save it into a file named save.p
pickle.dump(val, open("/home/data/refined/candescence/train-data/grace_tc/val_grace_tc.4.pkl", "wb"))  # save it into a file named save.p
