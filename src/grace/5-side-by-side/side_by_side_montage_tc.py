...
config_file = CANDESCENCE + "production/models/tc_config.py"
network_file =  CANDESCENCE + "production/models/tc_model.pth"
output_dir = CANDESCENCE + "performance/grace_tc/side_by_side_" + str(thresh) + "/"
target_file = CANDESCENCE + "train-data/grace_tc/val_grace_tc.pkl"



eval = Evaluator(config_file, network_file, target_file, CANDESCENCE + "train-data/grace_tc/val/")
